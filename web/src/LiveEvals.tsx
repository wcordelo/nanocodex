  ...
  return (
    <article className="eval-node-card">
      ...
      <div className="eval-node-counts">
        <div><span>Board claims</span><strong>{node.claimedTasks}</strong></div>
        <div><span>Host workers</span><strong>{node.workerProcesses}</strong></div>
        <div><span>Host VMs</span><strong>{node.vmProcesses}</strong></div>
